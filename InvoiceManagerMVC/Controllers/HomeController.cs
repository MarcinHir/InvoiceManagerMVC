...
using InvoiceManagerMVC.Models.Repositories;
using InvoiceManagerMVC.Models.ViewModels;
...
namespace InvoiceManagerMVC.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        private EditInvoiceViewModel PrepareInvoiceVm(Invoice invoice, string userId)
        {
            ...
            {
                Invoice = invoice,
                Heading = invoice.Id == 0 ? "Dodawanie Faktury" : "Edycja faktury",
        ...
        public ActionResult InvoicePosition(int invoiceId, int invoicePositionId = 0)
        {
            ...
            var invoicePosition = invoicePositionId == 0 ?
                ...
                _invoiceRepository.GetInvoicePostition(invoicePositionId, userId);
        ...
        public ActionResult DeletePosition(int id, int invoiceId)
        {
            ...
            {
                //logowanie
                return Json(new { Success = false, Message = "błąd w homecontroler " + exception.Message });
            }
